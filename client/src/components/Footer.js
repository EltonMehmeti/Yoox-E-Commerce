      ...
      <div className="grid grid-cols-12">
        ...
        <div className="col-span-6 text-center md:text-left md:col-span-3">
          ...
          <ul>
            ...
            <li>
              <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-400">Features</a>
            </li>
            <li>
              <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-400">Gallery</a>
            </li>
