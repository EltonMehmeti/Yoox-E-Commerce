...
const Header = () => {
  ...
  return (
    <nav class="bg-[#201f20] border-gray-200 dark:bg-gray-900 sticky z-50">
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
          <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-[#201f20] md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-[#201f20] dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <a
                href="#"
