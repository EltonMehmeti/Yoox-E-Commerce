...
import {faCheck, faTimes, faInfoCircle, faIcons} from "@fortawesome/free-solid-svg-icons";
...
const SignUp = () => {
 ...
 useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
   if(validName && validEmail && validPassword && validAddress && validCity && validPhone){
    axios
  ...
  return (
    <div className="h-screen w-full flex bg-orange-50">
      <div className="grid grid-cols-1 md:grid-cols-2 m-auto mt-10 shadow-lg bg-orange-50 sm:max-w-[1000px] h-[650px] rounded-lg">
        <form onSubmit={handleSubmit} className="  max-w-[350px] h-[500px] w-full rounded-lg mx-auto bg-orange-50 rounded  p-7">
          ...
          <div className="flex flex-col py-2 mb-2">
            ...
            />
              ...
              <p id="eidnote"
              className={`instructions ${nameFocus && name && !validName ? "" : "hidden"} font-sans text-xs mt-2`}>
              <FontAwesomeIcon icon={faInfoCircle} className=""/>
              <span className="font-bold ml-2 ">4 to 24 characters.</span><br />
          ...
          <div className="flex flex-col py-2 mb-2">
            ...
            />
              <p id="eidnote"
              className={`instructions ${emailFocus && email && !validEmail ? "" : "hidden"} font-sans text-xs mt-2`}>
              <span className="font-bold ml-2 ">Invalid email address</span><br />         
            </p>
          </div>
          <div className="flex flex-col py-2 mb-2">
            ...
            />
             <p id="pidnote"
              className={`instructions ${passwordFocus && password && !validPassword ? "" : "hidden"} font-sans text-xs mt-2`}>
               <FontAwesomeIcon icon={faInfoCircle} />
              <span className="font-bold ml-2 "> 8 to 24 characters</span><br />   
              Must include uppercase and lowercase letters, a number and a special character.<br/>
              Allowed special characters: <span aria-label="exclamation mark">!</span>     
              <span aria-label="at simbol">@</span>   <span aria-label="hashtag">#</span>   
          ...
          <div className="flex flex-row py-2 mb-0 ">
            ...
            <div className="flex flex-col py-2 pl-4 m-0">
              ...
              />
                <p id="pHidnote"
              className={`instructions ${phoneFocus && phone && !validPhone ? "" : "hidden"} font-sans text-xs mt-2`}>
              <span className="font-bold ml-2 text-xs"> Must contain 9 numbers</span><br />   
             </p>
