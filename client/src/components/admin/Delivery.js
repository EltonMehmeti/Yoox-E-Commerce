...
function ProgressBar({ progress }) {
  return (
    <div className="w-full bg-gray-300 rounded overflow-hidden">
      <div
        className="bg-orange-500  h-15 leading-none py-1 text-center text-white"
       ...
       <div className="  m-auto md:grid-cols-4 bg-white rounded-lg ">
        <form className="grid w-[950px] h-[300px] ">
          ...
          <div className=" flex gap-1 mr-4 ">
            ...
            <h4 className=" font-bold text-orange-500">Order processed</h4>
          </div>
          <div className=" flex  gap-1 mr-4" >
            <BsBoxSeamFill className="text-5xl"/>
            <h4 className="font-bold  text-orange-500">Order shipped</h4>
          </div>
          <div className=" flex  gap-1  mr-4">
            <MdLocalShipping className="text-5xl"/>
            <h4 className="font-bold text-orange-500 ">Order on route</h4>
          </div>
          <div className=" flex  gap-1 mr-4">
            <FaHome className="text-5xl"/>
            <h4 className="font-bold text-orange-500">Order arrived</h4>
          </div>
          </div>
        </form>
      </div>
